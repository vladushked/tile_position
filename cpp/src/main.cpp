...
void linesTracker(){
/* Рассматриваем 4 случая - аппарат смотрит прямо, направо, назад, влево. Направление получаем из функции определения угла.
 * На первом кадре определяем вертикальные и горизонтальные линии. Вводим счетчики горизонтальных и вертикальных линий.
 * Далее сравниваем найденные линии в предыдущем цикле с найденными в текущем цикле. Проходимся по массиву вертикальных линий.
 *
 * Несколько ситуаций:
 *      Если линий такое же количество, что и в предыдущий раз, то смотрим отклонение каждой.
 *          если у самой первой отклонение больше заданной дельты, то
 *              если у новой rho меньше, то декрементируем счетчик вертикальных линий.
 *              есди у новой rho больше, то инкрементируем счетчик вертикальных линий.
 *          если отклонение первой в пределах заданной дельты, берем следующий кадр.
 *      Если количество линий стало больше, то смотрим насколько стало больше
 *          если на одну то спереди или сзади
 *          если на две то
 *
 *
 *
